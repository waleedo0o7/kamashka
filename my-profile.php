            ...
            <div class="profile-data-content">
                ...
                <div class="items-group card">
                    <ul class="resetul">
                        ...
                        <li class="one-item">
                            <div class="content"> <i class="icon item-icon icon-help"></i> <a href="#"> Help </a> </div>
                            <div class="content"> <a href="#"><i class="fa arrow-icon fa-chevron-right"></i> </a></div>
                        </li><!-- one-item -->

                        <li class="one-item">
                            <div class="content"> <i class="icon item-icon icon-shield"></i> <a href="#"> Privacy Policy </a> </div>
                            <div class="content"> <a href="#"><i class="fa arrow-icon fa-chevron-right"></i> </a></div>
                        </li><!-- one-item -->

                        <li class="one-item">
                            <div class="content"> <i class="icon item-icon icon-check-form"></i> <a href="#"> Terms </a> </div>
                            <div class="content"> <a href="#"><i class="fa arrow-icon fa-chevron-right"></i> </a></div>
                        </li><!-- one-item -->
