            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="content">
                        ...
                        <a href="profile-ads-manager-list.php"><i class="sort icon icon-filter"></i><!-- icon --></a>
                    </div><!-- content -->
                </div> <!-- col-md-8 -->
            </div><!-- row -->
        </div><!-- container -->
                                        ...
                                        <div class="brand-slider">
                                            ...
                                            <div class="item">
                                                <a data-fancybox="nike-big-gallery" href="img/brand-slider/04.jpg">
                                                    <img src="img/brand-slider/04.jpg" class="img-fluid">
                                                </a>
                                            </div> <!-- item -->
                                            ...
                                            <div class="item">
                                                <a data-fancybox="nike-big-gallery" href="img/brand-slider/06.jpg">
                                                    <img src="img/brand-slider/06.jpg" class="img-fluid">
                                                </a>
                                            </div> <!-- item -->
                                ...
                                <div class="data-section">
                                    ...
                                    <div class="brand-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3> addidas <img class="img-fluid" src="img/verified.svg" /> </h3>
                                                <p> Kids Campaign <br />#zaracampaign </p>
                                            </div><!-- col-md-3 -->
                                            <div class="col-md-6 d-flex">
                                                <div class="follow-btn">
                                ...
                                <div class="data-section">
                                    ...
                                    <div class="brand-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3> Valencia <img class="img-fluid" src="img/verified.svg" /> </h3>
                                                <p> Kids Campaign <br />#zaracampaign </p>
                                            </div><!-- col-md-3 -->
                                            <div class="col-md-6 d-flex">
                                                <div class="follow-btn">
                                ...
                                <div class="data-section">
                                    ...
                                    <div class="brand-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3> Pepsi <img class="img-fluid" src="img/verified.svg" /> </h3>
                                                <p> Kids Campaign <br />#zaracampaign </p>
                                            </div><!-- col-md-3 -->
                                            <div class="col-md-6 d-flex">
                                                <div class="follow-btn">
