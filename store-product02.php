        ...
        <div class="product-page-wrapper">
            ...
            <div class="product-details-wrapper">
                ...
                <div class="product-details">
                    ...
                    <div class="title-and-price mb-2">
                        <div class="title">
                    ...
                    <div class="sold-by-and-rating mb-2">


                        <div class="image-and-name mb-3">
                            <span class="bold mr-2"> Sold By : </span>
                            <img alt="" class="img-fluid brand-image" src="img//brand-logo.png">
                            <div class="name-and-rate-wrapper">
                                <p class="bold"> Zara <img alt="" src="img//verified.svg" alt=""> </p>
                                <span class="fa fa-star checked"> 4.8 </span>
                            </div> <!-- name-and-rate-wrapper -->
                        </div><!-- image-and-name -->

                        <div class="rating-wrapper">

                            <div class="unknown-wrapper">20%</div><!-- unknown-wrapper -->
                    ...
                    <div class="attributes mb-5">
                        ...
                        <div class="size mb-4">
                            ...
                            <span class="item selected"> M </span>
                        ...
                        <div class="color">
                            ...
                            <span class="item" style="background-color: #C5DC1B;"> </span>
                            <span class="item selected" style="background-color: #FF77E5;"> <i class="fa fa-check"></i> </span>
                    ...
                    <div class="brand-description mb-3">
                        <p class="lead"> Nike Dri-FIT is a polyester fabric designed to help you keep dry so you can more comfortably work harder, longer. Nike Dri-FIT is a polyester fabric designed to help you keep dry so you can more comfortably work harder .</p>
                    ...
                    <div class="overview-and-specifications-wrapper custom-tabs">
                    ...
                    <div class="options delivery">
                        <p class="title"> <i class="icon icon-car"></i> Delivery Options </p>
                        <p class="mb-2"> Delivery By <span class="underline"> Fastpackage </span> </p>
                        <p> WILL DELIVERED <span class="bold"> TOMORROW, APR 6 </span> </p>
                    </div><!-- options -->
                    ...
                    <div class="reviews">
                        ...
                        <p class="text-center colored2 bold mt-3"> <a href="#"> See All Reviews </a> </p>
                    ...
                    <div class="more-from-store">
                        <p class="lead bold"> More From <a class="" href="store-profile.php"> Zara </a></p>
                    ...
                    <div class="related-products mb-5 ">
                        ...
                        <p class="lead bold"> Related Products </p>
            ...
            <div class="product-slider-wrapper">
                ...
                <div class="actions-wrapper">
                    <a href="#"> <i class="toggle-like-btn icon icon-heart-solid"></i> </a>
                    <a href="#"> <i class="icon icon-expand"></i> </a>
    ...
    <div class="modal-dialog  " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add-review-modalLabel"> Write Review </h5>
            ...
            <div class="modal-body">
                ...
                <div class="add-review-wrapper">
                    ...
                    <div class="form-group mb-3">
                        <textarea id="review" class="form-control" placeholder="Tell us your experience"></textarea>
                    </div><!-- form-group -->

                </div><!-- add-review-wrapper -->
